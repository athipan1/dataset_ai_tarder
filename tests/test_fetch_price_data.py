...
class TestFetchPriceData(unittest.TestCase):
    ...
    @patch("scripts.fetch_price_data.pg_insert")
    def test_save_data_to_db(self, mock_pg_insert):
        ...
        mock_pg_insert.assert_called_once_with(PriceData)
    ...
    @patch("scripts.fetch_price_data.pg_insert")
    def test_save_data_to_db_skip_existing(self, mock_pg_insert):
