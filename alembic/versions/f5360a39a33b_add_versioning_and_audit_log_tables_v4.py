...
def upgrade() -> None:
    ...
    sa.Column('action', sa.Enum('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'ACCESS', name='auditaction'), nullable=False),
    ...
    op.create_index('ix_audit_log_table_record_timestamp', 'audit_logs', ['table_name', 'record_pk', 'timestamp'], unique=False)
    op.create_index('ix_audit_log_user_action_timestamp', 'audit_logs', ['user_id', 'action', 'timestamp'], unique=False)
