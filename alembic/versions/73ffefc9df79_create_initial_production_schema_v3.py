...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_type",
            sa.Enum("CRYPTO", "FOREX", "STOCK", "ETF", "COMMODITY", "INDEX", "UNKNOWN", name="assettype"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_price_data_asset_id_timestamp_source", "price_data", ["asset_id", "timestamp", "source"], unique=True
    )
    ...
    op.create_index(
        "ix_backtest_result_strategy_id_created_at", "backtest_results", ["strategy_id", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "signal_type",
            sa.Enum("BUY", "SELL", "HOLD", "STRONG_BUY", "STRONG_SELL", name="signaltype"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_signal_asset_strategy_timestamp", "signals", ["asset_id", "strategy_id", "timestamp"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "executed_at", sa.DateTime(timezone=True), server_default=sa.text("(CURRENT_TIMESTAMP)"), nullable=True
        ),
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(
        "ix_trade_user_id_symbol_executed_at", "trades", ["user_id", "symbol", "executed_at"], unique=False
    )
