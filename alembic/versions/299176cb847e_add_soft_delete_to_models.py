...
def upgrade() -> None:
    ...
    op.add_column('strategies', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    ...
    op.create_index(op.f('ix_strategies_is_deleted'), 'strategies', ['is_deleted'], unique=False)

    op.add_column('trades', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    ...
    op.add_column('user_behavior_logs', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('user_behavior_logs', sa.Column('deleted_at', sa.DateTime(), nullable=True))
    op.create_index(op.f('ix_user_behavior_logs_deleted_at'), 'user_behavior_logs', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_user_behavior_logs_is_deleted'), 'user_behavior_logs', ['is_deleted'], unique=False)

    # Add soft delete columns to trade_analytics
    op.add_column('trade_analytics', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('trade_analytics', sa.Column('deleted_at', sa.DateTime(), nullable=True))
    op.create_index(op.f('ix_trade_analytics_deleted_at'), 'trade_analytics', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_trade_analytics_is_deleted'), 'trade_analytics', ['is_deleted'], unique=False)

    # Add soft delete columns to backtest_results
    op.add_column('backtest_results', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column('backtest_results', sa.Column('deleted_at', sa.DateTime(), nullable=True))
    op.create_index(op.f('ix_backtest_results_deleted_at'), 'backtest_results', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_backtest_results_is_deleted'), 'backtest_results', ['is_deleted'], unique=False)
    ...
    op.create_index(op.f('ix_signals_is_deleted'), 'signals', ['is_deleted'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_behavior_logs_is_deleted'), table_name='user_behavior_logs')
    op.drop_index(op.f('ix_user_behavior_logs_deleted_at'), table_name='user_behavior_logs')
