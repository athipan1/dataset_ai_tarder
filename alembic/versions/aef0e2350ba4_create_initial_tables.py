...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "price_data",
        ["asset_id", "timestamp", "source"],
        unique=True,
    )
    op.create_index(op.f("ix_price_data_id"), "price_data", ["id"], unique=False)
    op.create_index(
        op.f("ix_price_data_timestamp"), "price_data", ["timestamp"], unique=False
    )
    op.create_table(
        "strategies",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "order_side", sa.Enum("BUY", "SELL", name="orderside"), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_index(
        op.f("ix_orders_exchange_order_id"),
        "orders",
        ["exchange_order_id"],
        unique=False,
    )
