from sqlalchemy import Column, Integer, String, DateTime, Numeric, ForeignKey, Enum as DBEnum, Index, Text, JSON, UniqueConstraint
...
class TradeVersion(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id", ondelete="SET NULL"), nullable=True) # Original user_id might change
